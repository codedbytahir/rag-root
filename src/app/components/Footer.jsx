      ...
      <div className="flex justify-center">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8 max-w-[1280px] w-full px-4 sm:px-10">
          ...
          <div className="flex gap-8 text-sm text-gray-500">
            <Link href="/docs" className="hover:text-[#39E079] transition-colors">Documentation</Link>
            <Link href="/docs" className="hover:text-[#39E079] transition-colors">API Reference</Link>
