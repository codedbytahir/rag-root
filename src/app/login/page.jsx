        ...
        <div className="relative w-full max-w-[400px] z-10">
            ...
            <div className="relative bg-[#0c1212]/90 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl">
                ...
                <button 
                    ...
                    className="group relative w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-50 text-[#0c1212] font-bold py-3.5 px-4 rounded-xl transition-all duration-200 transform hover:scale-[1.02] shadow-[0_0_20px_rgba(255,255,255,0.05)] hover:shadow-[0_0_25px_rgba(57,224,121,0.4)] overflow-hidden"
                >
                    {/* Google SVG */}
